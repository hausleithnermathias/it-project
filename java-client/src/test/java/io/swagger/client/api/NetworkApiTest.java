...
public class NetworkApiTest {
     ...
     */
    @Test
    public void printerNetworkGetTest() throws ApiException {
        Network response = api.printerNetworkGet();
     ...
     */
    @Test
    public void printerNetworkSSIDGetTest() throws ApiException {
        String response = api.printerNetworkSSIDGet();
     ...
     */
    @Test
    public void printerNetworkWifiNetworksGetTest() throws ApiException {
        List<WifiNetwork> response = api.printerNetworkWifiNetworksGet();
     ...
     */
    @Test
    public void printerNetworkWifiNetworksSsidDeleteTest() throws ApiException {
        String ssid = null;
        api.printerNetworkWifiNetworksSsidDelete(ssid);
     ...
     */
    @Test
    public void printerNetworkWifiNetworksSsidPutTest() throws ApiException {
        String ssid = null;
        String passphrase = null;
        api.printerNetworkWifiNetworksSsidPut(ssid, passphrase);
